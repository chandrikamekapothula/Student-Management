...
<h3>${msg }</h3>
<form:form  action="/submitidedit" modelAttribute="student">
<table id="stu1form">
<tr><td><h1 id="stu1h1">Edit Student Details </h1></td></tr>
<tr>
<td><form:label path="id">Student Id </form:label> </td>
<td><form:input type="number" path="id" placeholder="Enter ID" required="required"></form:input></td>
<td><button type="submit" value="Submit">Submit to Edit</button></td>

</tr>
</form:form>
<form:form action="/submitstuedit" modelAttribute="student">
<tr>
